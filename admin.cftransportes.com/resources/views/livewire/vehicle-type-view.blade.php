<div>
    <a href="{{route('vehicle-type-index')}}" class="btn btn-primary my-3">{{ __('Listar Tipos de Vehículo') }}</a>
    <x-breadcrumb title="Tipos de Vehículo" route="Tipos de Vehículo,Ver" />
